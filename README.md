...
| **OWID Air Pollution Deaths** | Country-level mortality from indoor and outdoor air pollution (IHME GBD) | [github.com/owid/owid-datasets](https://github.com/owid/owid-datasets) | Auto-downloaded via URL (fallback hardcoded) |
...
│   └── 06_equity_viz.R          # Centrepiece equity scatter + income group paradox — 2 plots
├── data/
...
- **06_equity_viz.R** — Produces the centrepiece equity scatter and income group paradox plot showing the inverse relationship between emissions and health burden.
...
| Air pollution mortality gap | Low-income countries bear **30×+ higher** death rates than high-income countries despite emitting a fraction of the CO2 per capita |
...
*Countries in the top-left quadrant emit little CO2 per capita but face the highest air pollution mortality. Countries in the bottom-right emit heavily but are shielded by wealth and healthcare capacity.*
